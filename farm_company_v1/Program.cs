...
namespace farm_company_v1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            f1.Stratum = 2;
            f1.Gender = 0;
            listasFarmersAndCrops.AñadirFarmers(f1);

            Farmer f2 = new Farmer();
            f2.Name = "Pablo";
            f2.Stratum = 2;
            f2.Gender = 0;
            listasFarmersAndCrops.AñadirFarmers(f2);

            Farmer f3 = new Farmer();
            f3.Name = "Maria";
            f3.Stratum = 2;
            f3.Gender = 1;
            listasFarmersAndCrops.AñadirFarmers(f3);

            Farmer f4 = new Farmer();
            f4.Name = "Pedro";
            f4.Stratum = 2;
            f4.Gender = 0;
            listasFarmersAndCrops.AñadirFarmers(f4);

            Farmer f5 = new Farmer();
            f5.Name = "Stella";
            f5.Stratum = 2;
            f5.Gender = 1;
            listasFarmersAndCrops.AñadirFarmers(f5);
            ...
            listasFarmersAndCrops.AñadirProdut(p1);
            ...
            listasFarmersAndCrops.AñadirProdut(p2);
            ...
            listasFarmersAndCrops.AñadirProdut(p3);
            ...
            listasFarmersAndCrops.AñadirProdut(p4);
            ...
            listasFarmersAndCrops.AñadirProdut(p5);
            ...
            listasFarmersAndCrops.AñadirProdut(p6);
            ...
            listasFarmersAndCrops.AñadirProdut(p7);
